...
?>
<main>
    <div class="banner-head" id="spatial">
        <div class="banner-box">
            <h1 id="spatial-color">SPATIAL</h1>
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <a href="../articles/content/article.php" class="bart" id="<?php echo $id?>">
                        <article class="art" id="<?php echo 'id' . $id ?>">
                            <div class="color-barre" id="spatial-color"></div>
                            <div class="bright">
    ...
    <section class="main-container">
        <div class="article-list">
            <div class="title">
                <h3 id="spatial-color">                <?php $type = $_GET["type"] ?? '';
        ...
        <aside id="aside">
            <div class="article-category">
                ...
                <a href="spatial.php?type=actualite" class="nav-category"><p>Actualité</p></a>
                <a href="spatial.php?type=technologie" class="nav-category"><p>Technologie</p></a>
                <a href="spatial.php?type=histoire" class="nav-category"><p>Histoire</p></a>
                <a href="spatial.php?type=creation" class="nav-category"><p>Créations</p></a>
                <a href="spatial.php?type=quiz" class="nav-category"><p>Quiz</p></a>
                <div class="color-bar" id="spatial-color"></div>
            </div>
